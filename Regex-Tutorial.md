...
Below I have provided a tutorial that wil explain the specifics of regex so other can understand the search pattern that regex uses

## Summary

A string of characters known as a regex, or regular expression, designates a search pattern. String-searching algorithms typically employ these patterns when performing "find" or "find and replace" operations on strings. It also searches for input checks. It's a method that was developed frequently in theoretical computer science.
...
Quantifiers specify that the token before it needs to match a specific number of times. Below is an explanation of greedy and lazy quantifires.
...
Character classes correspond to a certain collection of characters. There are several character classes that are already specified, and you can also create your own sets.
...
Nicholas Le
My Github [github] https://github.com/nle641999?tab=repositories
